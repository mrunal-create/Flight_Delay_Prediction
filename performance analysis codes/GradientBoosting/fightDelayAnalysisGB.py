...
def analyze_performance(parallelism_levels, parquet_path, target_column='DepDelay'):
    cleaning_times = []
    training_times = []
    ...
    plt.plot(parallelism_levels, training_times, label='Training Time')
    plt.title('Training Time vs Number of Cores(Gradient Boosting Spark) Partition Size = 50, Threads = 3')
...
parallelism_levels = [1, 2, 3, 4, 5]
# file_path = "concatenated_data.csv"
parquet_path = "/home/ghosh.shu/EECE/flightData.parquet"
analyze_performance(parallelism_levels, parquet_path, target_column='DepDelay')
